...
def validate_employee_id_(employee_id):
...
def validate_address_input(address):
...
def validate_mobile_number_input(mobile_number):
...
def validate_education_input(education):
...
def validate_salary_input(salary):
...
def validate_joining_date_input(joining_date):
    try:
    ...
    year, month, day = map(int, joining_date.split('-'))
...
def validate_department_input(department):
...
def validate_project_name_input(project_name):
...
def validate_tech_stack_input(tech_stack):
...
def validate_annual_salary_input(annual_salary):
...
# Function to validate education details input
def validate_manager_input(manager):
...
def update_employee_info(connection, cursor):
    while True:
        try:
            ...
            if not validate_employee_id_(employee_id):
            ...
            if employee:
                ...
                if choice == '1':
                    # Update age
                    age = None
                    while age is None or not validate_age_input(age):
                        age = input("Enter new age: ").strip()
                        if not validate_age_input(age):
                    ...
                    # Update gender
                    gender = None
                    while not gender or not validate_gender_input(gender):
                        gender = input("Enter new gender (male/female/other): ").strip().lower()
                        if not validate_gender_input(gender):
                    ...
                    while not doj:
                        ...
                        if not doj_input:
                            print("Date of joining cannot be empty.")
                        elif not validate_joining_date_input(doj_input):
                            print("Invalid date format. Date of joining should follow the format YYYY-MM-DD.")
                        else:
                            doj = doj_input
                    ...
                    while not annual_salary:
                        ...
                        if not annual_salary_input:
                            print("Annual salary cannot be empty.")
                        elif not validate_annual_salary_input(annual_salary_input):
                    ...
                    while not project:
                        ...
                        elif not validate_project_name_input(project):
...
def delete_inactive_employee(connection):
    cursor = connection.cursor()
...
def list_all_employee(connection):
    cursor = connection.cursor()
    try:
...
def assigning_projects(connection):
    try:
        cursor = connection.cursor()
...
def main():
    ...
    if connection:
        ...
        instering_rand_data(connection, num_records=100)
